...
const AddService = () => {
  ...
  return (
    <View>
      <TouchableOpacity style={styles.appointments} onPress={onPageOpen}>
        <Image
      ...
      {open && (
        <View style={styles.servicesPage}>
          <InputField
            ...
            onChangeText={(text: any) => handleInputChange("serviceName", text)}
          />
          <InputField
            width={300}
            borderBottomWidth={1}
            ...
            onChangeText={(text: any) => handleInputChange("duration", text)}
          />
          <InputField
            width={300}
            borderBottomWidth={1}
